...
constexpr const char* lookupSelinuxContext(const domain d, const char* const unspecified = "") {
    switch (d) {
        ...
        case domain::firewall_private:   return "fs_bpf_firewall_private";
        case domain::firewall_readonly:  return "fs_bpf_firewall_readonly";
        case domain::firewall_shared:    return "fs_bpf_firewall_shared";
...
constexpr const char* lookupPinSubdir(const domain d, const char* const unspecified = "") {
    switch (d) {
        ...
        case domain::firewall_private:   return "firewall_private/";
        case domain::firewall_readonly:  return "firewall_readonly/";
        case domain::firewall_shared:    return "firewall_shared/";
